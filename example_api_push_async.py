...
async def main():
    ...
    try:
        ...
        api = AsyncDabPumpsPush(TEST_USERNAME, TEST_PASSWORD)
        await api.login()
        ...
        def show_device_state(serial: str, device_state: DabPumpsDeviceState = None):
        ...
        for serial in api.device_map.keys():
            show_device_state(device.serial)
