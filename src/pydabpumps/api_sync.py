...
class DabPumps:
    ...
    def __init__(self, username, password, client:httpx.Client=None, login_info:DabPumpsLoginInfo=None, access_token_info:DabPumpsAccessTokenInfo=None, refresh_token_info:DabPumpsRefreshTokenInfo=None):
        # Configuration
    ...
    def _login_access_token(self) -> bool:
        ...
        self._update_diagnostics(datetime.now(), context, None, None, self._access_token_info)
    ...
    def fetch_install_details(self, install_id: str):
        ...
        for serial in [ d.serial for d in self._device_map.values() if d.install_id==install_id ]:
            self._fetch_static_statuses(serial)
            self._fetch_device_statuses(serial, raw_install_data=raw)
    ...
    def _fetch_static_statuses(self, serial: str):
        ...
        for params in config.meta_params.values():
            ...
            if is_static:
                status_key = DabPumps.create_id(device.serial, params.key)
    ...
    def _fetch_device_statuses(self, serial: str, raw_install_data: dict|None = None):
        ...
        for item_key, item_code in values.items():
            try:
                ...
                status_key = DabPumps.create_id(serial, item_key)
    ...
    def change_device_status(self, serial: str, key: str, code: str|None=None, value: Any|None=None):
        ...
        status_key = DabPumps.create_id(serial, key)  
